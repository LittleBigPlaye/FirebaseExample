...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtPassword = findViewById<EditText>(R.id.txtPasswordRegister)
        ...
        FirebaseAuth.getInstance().createUserWithEmailAndPassword(email, password).addOnCompleteListener(
            OnCompleteListener<AuthResult> { task ->
                if(task.isSuccessful) {
                    ...
                    Toast.makeText(this@RegisterActivity, "Logged In", Toast.LENGTH_SHORT).show()

                    val intent = Intent(this@RegisterActivity, LoggedInActivity::class.java)
                    ...
                    Toast.makeText(this@RegisterActivity, task.exception!!.message.toString(), Toast.LENGTH_SHORT)
                }
            }
        )
    }
